        ...
        <div className="flex flex-col gap-6">
            ...
            <form onSubmit={handleSubmit} className="glass-card flex flex-col gap-5">
                <div className="flex flex-col gap-1.5">
                    ...
                    <div className="flex items-center gap-3 bg-black/5 p-3.5 rounded-xl border border-black/5">
                ...
                <div className="flex flex-col gap-1.5">
                    ...
                    <div className="flex items-center gap-3 bg-black/5 p-3.5 rounded-xl border border-black/5">
                        ...
                        <input
                            ...
                            className="bg-transparent border-none outline-none w-full text-slate-800 uppercase font-mono"
                            value={formData.ifsc}
